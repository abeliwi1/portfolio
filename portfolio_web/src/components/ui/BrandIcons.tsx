...
/**
 * Brand marks that Lucide no longer ships (removed in v1). Both accept the
 * same `size` prop as Lucide icons so they can be swapped in freely.
 */
...
export function GithubIcon({ size = 16, ...rest }: BrandIconProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
...
export function LinkedinIcon({ size = 16, ...rest }: BrandIconProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
